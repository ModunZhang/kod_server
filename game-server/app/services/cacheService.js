	...
	if(_.isObject(alliance)){
		...
		self.Alliance.findOneAsync({_id:id, 'serverId':self.cacheServerId}).then(function(doc){
			...
			if(_.isObject(doc)){
				...
				if(monsterRefreshTime < minRefreshInterval) monsterRefreshTime = 999 * 60//_.random(1000, 2000) * 60;
				if(villageRefreshTime < minRefreshInterval) villageRefreshTime = 999 * 60//_.random(1000, 2000) * 60;
