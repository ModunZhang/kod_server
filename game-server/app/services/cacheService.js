	...
	if(_.isObject(alliance)){
		...
		self.Alliance.findOneAsync({_id:id, 'serverId':self.cacheServerId}).then(function(doc){
			...
			if(_.isObject(doc)){
				...
				if(monsterRefreshTime < minRefreshInterval) monsterRefreshTime = 1000 * 60 - 10//_.random(1000, 2000) * 60;
				if(villageRefreshTime < minRefreshInterval) villageRefreshTime = 1000 * 60 - 1//_.random(1000, 2000) * 60;
