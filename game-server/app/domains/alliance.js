...
var createBuildingSchema = function(name, x, y){
	var schema = {
		...
		location: {
			x: {type: Number, required: true, default: x}, y: {type: Number, required: true, default: y}
		}
	}
	return schema
}
...
var allianceSchema = new Schema({
	_id: {type: String, required: true, unique: true, default: ShortId.generate}, basicInfo: {
	...
	notice: {type: String, required: false}, desc: {type: String, required: false},
	titles: {
