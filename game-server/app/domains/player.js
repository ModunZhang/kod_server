...
var playerSchema = new Schema({
	...
	buildings:{
		location_1:{
			type:{type:String, required:true, default:LocationInitData[1].name},
			level:{type:Number, required:true, default:1},
		...
		location_2:{
			type:{type:String, required:true, default:LocationInitData[2].name},
			level:{type:Number, required:true, default:1},
			location:{type:Number, required:true, default:1},
			finishTime:{type:Number, required:true, default:0},
			houses:[
		...
		location_3:{
			type:{type:String, required:true, default:LocationInitData[3].name},
			level:{type:Number, required:true, default:1},
		...
		location_4:{
			type:{type:String, required:true, default:LocationInitData[4].name},
			level:{type:Number, required:true, default:1},
		...
		location_5:{
			type:{type:String, required:true, default:LocationInitData[5].name},
		...
		location_6:{
			type:{type:String, required:true, default:LocationInitData[6].name},
			level:{type:Number, required:true, default:0},
		...
		location_7:{
			type:{type:String, required:true, default:LocationInitData[7].name},
			level:{type:Number, required:true, default:0},
		...
		location_8:{
			type:{type:String, required:true, default:LocationInitData[8].name},
			level:{type:Number, required:true, default:0},
		...
		location_9:{
			type:{type:String, required:true, default:LocationInitData[9].name},
			level:{type:Number, required:true, default:0},
		...
		location_10:{
			type:{type:String, required:true, default:LocationInitData[10].name},
			level:{type:Number, required:true, default:-1},
		...
		location_11:{
			type:{type:String, required:true, default:LocationInitData[11].name},
			level:{type:Number, required:true, default:-1},
		...
		location_12:{
			type:{type:String, required:true, default:LocationInitData[12].name},
			level:{type:Number, required:true, default:-1},
		...
		location_13:{
			type:{type:String, required:true, default:LocationInitData[13].name},
			level:{type:Number, required:true, default:-1},
		...
		location_14:{
			type:{type:String, required:true, default:LocationInitData[14].name},
			level:{type:Number, required:true, default:-1},
		...
		location_15:{
			type:{type:String, required:true, default:LocationInitData[15].name},
			level:{type:Number, required:true, default:-1},
		...
		location_16:{
			type:{type:String, required:true, default:LocationInitData[16].name},
			level:{type:Number, required:true, default:-1},
