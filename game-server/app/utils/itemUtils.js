...
var MoveTheCity = function(playerDoc, playerData, locationX, locationY, allianceDao, updateFuncs, pushFuncs, pushService){
	...
	return allianceDao.findAsync(playerDoc.alliance.id).then(function(doc){
		...
		var marchEvents = []
		marchEvents = marchEvents.concat(allianceDoc.attackMarchEvents, allianceDoc.attackMarchReturnEvents, allianceDoc.strikeMarchEvents, strikeMarchReturnEvents)
		console.log(marchEvents, "11111111111111111")
