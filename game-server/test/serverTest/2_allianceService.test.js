...
describe("AllianceService", function(){
	...
	describe("allianceHandler", function(){
		...
		//it("attackVillage 采集敌方方联盟村落 敌对方进攻且敌对方胜利", function(done){
		//	setTimeout(function(){
		//		var m_myAllianceData = null
		//		var m_enemyAllianceData = null
		//		Api.loginPlayer(Config.deviceId3, function(doc){
		...
		//it("attackVillage 采集敌方方联盟村落 敌对方进攻且敌对方胜利,但敌对方龙死亡", function(done){
		//	setTimeout(function(){
		//		var m_myAllianceData = null
		//		var m_enemyAllianceData = null
		//		Api.loginPlayer(Config.deviceId3, function(doc){
		...
		//it("attackVillage 采集敌方盟村落 敌对方进攻且敌对方失败", function(done){
		//	setTimeout(function(){
		//		var m_myAllianceData = null
		//		var m_enemyAllianceData = null
		//		Api.loginPlayer(Config.deviceId3, function(doc){
		...
		//it("attackVillage 采集敌方联盟村落 敌对方进攻且敌对方失败,但我方龙死亡", function(done){
		//	setTimeout(function(){
		//		var m_myAllianceData = null
		//		var m_enemyAllianceData = null
		//		Api.loginPlayer(Config.deviceId3, function(doc){
