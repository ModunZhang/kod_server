	...
	return new Promise(function(resolve){
		...
		(function updatePlayer(){
			cursor.next(function(e, doc){
				...
				doc.dragons.redDragon.skill_1.name = 'hellFire';
				doc.dragons.redDragon.skill_2.name = 'infantryEnhance';
				doc.dragons.redDragon.skill_3.name = 'archerEnhance';
				doc.dragons.redDragon.skill_4.name = 'cavalryEnhance';
				doc.dragons.redDragon.skill_5.name = 'siegeEnhance';
				doc.dragons.redDragon.skill_6.name = 'dragonBreath';
				doc.dragons.redDragon.skill_7.name = 'dragonBlood';
				doc.dragons.redDragon.skill_8.name = 'leadership';
				doc.dragons.redDragon.skill_9.name = 'greedy';
				doc.dragons.blueDragon.skill_1.name = 'lightningStorm';
				doc.dragons.blueDragon.skill_2.name = 'infantryEnhance';
				doc.dragons.blueDragon.skill_3.name = 'archerEnhance';
				doc.dragons.blueDragon.skill_4.name = 'cavalryEnhance';
				doc.dragons.blueDragon.skill_5.name = 'siegeEnhance';
				doc.dragons.blueDragon.skill_6.name = 'dragonBreath';
				doc.dragons.blueDragon.skill_7.name = 'dragonBlood';
				doc.dragons.blueDragon.skill_8.name = 'leadership';
				doc.dragons.blueDragon.skill_9.name = 'surge';
				doc.dragons.greenDragon.skill_1.name = 'poisonNova';
				doc.dragons.greenDragon.skill_2.name = 'infantryEnhance';
				doc.dragons.greenDragon.skill_3.name = 'archerEnhance';
				doc.dragons.greenDragon.skill_4.name = 'cavalryEnhance';
				doc.dragons.greenDragon.skill_5.name = 'siegeEnhance';
				doc.dragons.greenDragon.skill_6.name = 'dragonBreath';
				doc.dragons.greenDragon.skill_7.name = 'dragonBlood';
				doc.dragons.greenDragon.skill_8.name = 'leadership';
				doc.dragons.greenDragon.skill_9.name = 'earthquake';
